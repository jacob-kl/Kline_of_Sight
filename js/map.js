...
function initGlobe() {
  ...
  globeInstance = Globe()
    ...
    // VISUAL pin markers only — no click handlers live here. HTML
    // overlays on top of a draggable WebGL canvas are notoriously
    // unreliable for click/tap detection across browsers (OrbitControls'
    // touchmove preventDefault can cancel the synthetic click the browser
    // would otherwise fire). So this layer is purely decorative now.
    .htmlElementsData([])
